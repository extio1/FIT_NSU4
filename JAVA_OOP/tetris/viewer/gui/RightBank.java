...
class RightBank extends JPanel {
    ...
    public void updateNextFigure(FigureDescriptor fd){
        nextFigureView  = fd.getView();
        nextFigureXSize = fd.getWidth();
        nextFigureYSize = fd.getLength();
        figureNum       = fd.getOrdinal();
        repaint();
    }
    ...
    private void createMenuButton(JLayeredPane lp){
        ...
        menuButton.setBounds(468,640,64,64);
